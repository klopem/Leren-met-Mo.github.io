...
<head>
  ...
  <style>
    ...
    h1::after {
      content: " - Created by Mohamad Hammadeh, enjoy"; /* Add your name here */
      font-size: 0.8em;
      color: #555;
    }
    table {
    ...
    button:hover {
      background: #1c6b1c; /* Darker green */
    }
    #feedback {
      margin-top: 15px;
      font-weight: bold;
...
<body>
  ...
  <table>
    ...
    <tr><td class="word-number">40</td><td>impress</td><td>indruk maken op</td></tr>
